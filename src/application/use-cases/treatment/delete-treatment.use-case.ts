...
import { IDeleteTreatmentUseCase } from '../../interfaces/use-cases/treatment/treatment-use-cases.interface';

@injectable()
export class DeleteTreatmentUseCase implements IDeleteTreatmentUseCase {
  constructor(
