...
export const setupTreatmentCourseRoutes = (router: Router, resolver: DependencyContainer): void => {
  const treatmentCourseController = resolver.resolve(TreatmentCourseController);
