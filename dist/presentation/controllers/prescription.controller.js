...
let PrescriptionController = class PrescriptionController {
    constructor(createPrescriptionUseCase, getPrescriptionUseCase, getAllPrescriptionsUseCase, updatePrescriptionUseCase, deletePrescriptionUseCase) {
        this.createPrescriptionUseCase = createPrescriptionUseCase;
        this.getPrescriptionUseCase = getPrescriptionUseCase;
        this.getAllPrescriptionsUseCase = getAllPrescriptionsUseCase;
    ...
    async create(req, res, next) {
        ...
        (0, constants_1.successResponse)(res, prescription, constants_1.HttpStatus.CREATED, constants_1.SuccessMessages.CREATED);
    }
    async getById(req, res, next) {
        const id = req.params.id;
        if (!id) {
            throw new validation_error_1.ValidationError('Prescription ID is required');
        }
        const doctorId = (0, user_context_util_1.getUserId)(req);
        const prescription = await this.getPrescriptionUseCase.execute(id, doctorId);
        (0, constants_1.successResponse)(res, prescription, constants_1.HttpStatus.OK, constants_1.SuccessMessages.RETRIEVED);
    }
    ...
    async update(req, res, next) {
        ...
        (0, constants_1.successResponse)(res, prescription, constants_1.HttpStatus.OK, constants_1.SuccessMessages.UPDATED);
    }
    async delete(req, res, next) {
        ...
        (0, constants_1.successResponse)(res, { message: 'Prescription deleted successfully' }, constants_1.HttpStatus.OK, constants_1.SuccessMessages.DELETED);
    }
};
...
exports.PrescriptionController = PrescriptionController = __decorate([
    ...
    __param(0, (0, tsyringe_1.inject)('ICreatePrescriptionUseCase')),
    __param(1, (0, tsyringe_1.inject)('IGetPrescriptionUseCase')),
    __param(2, (0, tsyringe_1.inject)('IGetAllPrescriptionsUseCase')),
    __param(3, (0, tsyringe_1.inject)('IUpdatePrescriptionUseCase')),
    __param(4, (0, tsyringe_1.inject)('IDeletePrescriptionUseCase')),
