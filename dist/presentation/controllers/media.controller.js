...
let MediaController = class MediaController {
    constructor(createMediaUseCase, updateMediaUseCase, deleteMediaUseCase, getMediaUseCase, getAllMediaUseCase) {
        ...
        this.getAllMediaUseCase = getAllMediaUseCase;
    }
    async create(req, res, next) {
        ...
        (0, constants_1.successResponse)(res, media, constants_1.HttpStatus.CREATED, constants_1.SuccessMessages.CREATED);
    }
    async update(req, res, next) {
        ...
        (0, constants_1.successResponse)(res, media, constants_1.HttpStatus.OK, constants_1.SuccessMessages.UPDATED);
    }
    ...
    async getById(req, res, next) {
        ...
        (0, constants_1.successResponse)(res, media, constants_1.HttpStatus.OK, constants_1.SuccessMessages.RETRIEVED);
    }
    ...
    buildQueryDto(req) {
        ...
        const allowedSortBy = ['createdAt', 'type'];
...
exports.MediaController = MediaController = __decorate([
    ...
    __param(0, (0, tsyringe_1.inject)('ICreateMediaUseCase')),
    __param(1, (0, tsyringe_1.inject)('IUpdateMediaUseCase')),
    __param(2, (0, tsyringe_1.inject)('IDeleteMediaUseCase')),
    __param(3, (0, tsyringe_1.inject)('IGetMediaUseCase')),
    __param(4, (0, tsyringe_1.inject)('IGetAllMediaUseCase')),
