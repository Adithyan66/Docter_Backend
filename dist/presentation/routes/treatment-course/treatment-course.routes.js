...
const setupTreatmentCourseRoutes = (router) => {
    const treatmentCourseController = container_1.container.resolve(treatment_course_controller_1.TreatmentCourseController);
