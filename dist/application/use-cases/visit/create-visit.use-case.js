...
let CreateVisitUseCase = class CreateVisitUseCase {
    constructor(visitRepository, treatmentCourseRepository, patientRepository, doctorRepository, prescriptionRepository, mediaRepository, clinicRepository, treatmentRepository, paymentRepository) {
