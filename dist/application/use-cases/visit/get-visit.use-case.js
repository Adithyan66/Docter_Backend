...
let GetVisitUseCase = class GetVisitUseCase {
    ...
    async execute(id, doctorId) {
        ...
        return (0, visit_mapper_1.visitToDto)(visit);
    }
};
exports.GetVisitUseCase = GetVisitUseCase;
exports.GetVisitUseCase = GetVisitUseCase = __decorate([
