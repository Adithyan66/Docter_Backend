...
exports.AddClinicImagesUseCase = void 0;
...
let AddClinicImagesUseCase = class AddClinicImagesUseCase {
    constructor(clinicRepository) {
        this.clinicRepository = clinicRepository;
    }
    async execute(clinicId, doctorId, imageUrls) {
...
exports.AddClinicImagesUseCase = AddClinicImagesUseCase;
exports.AddClinicImagesUseCase = AddClinicImagesUseCase = __decorate([
    (0, tsyringe_1.injectable)(),
    __param(0, (0, tsyringe_1.inject)('IClinicRepository')),
    __metadata("design:paramtypes", [Object])
], AddClinicImagesUseCase);
