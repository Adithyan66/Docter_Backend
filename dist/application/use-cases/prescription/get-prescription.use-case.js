...
let GetPrescriptionUseCase = class GetPrescriptionUseCase {
    ...
    async execute(id, doctorId) {
        ...
        return (0, prescription_mapper_1.prescriptionToDto)(prescription);
    }
};
exports.GetPrescriptionUseCase = GetPrescriptionUseCase;
exports.GetPrescriptionUseCase = GetPrescriptionUseCase = __decorate([
